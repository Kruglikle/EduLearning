...
const courses = [
  ...
  {
    id: "blender-zero",
    title: "Blender для архитектуры",
    direction: "Blender",
    filter: "Blender",
    level: "Beginner",
    duration: "6 недель",
    summary: "Архитектурное моделирование с нуля: комнаты, дома, небольшие городские сцены, материалы, свет и финальный рендер.",
    result: "Готовая архитектурная сцена — интерьер или экстерьер — для первого проекта в портфолио.",
    audience: "Новичкам в Blender, начинающим дизайнерам и тем, кто хочет создавать интерьеры, дома и городские сцены.",
    learn: ["моделировать помещение и фасад по референсам", "собирать архитектурную сцену в правильном масштабе", "настраивать материалы и естественное освещение", "готовить выразительный ракурс и финальный рендер"],
    modules: [
      { number: "0", title: "Старт и архитектурные референсы", description: "Интерфейс Blender, навигация, масштаб и подготовка референсов для будущей сцены." },
      { number: "1", lessons: "Занятия 2–3", title: "Комната с нуля", description: "Стены, проёмы, мебель и организация простой интерьерной сцены." },
      { number: "2", lessons: "Занятия 4–5", title: "Дом и фасад", description: "Моделирование основных архитектурных форм, окон, крыши и деталей фасада." },
      { number: "3", lessons: "Занятия 6–7", title: "Материалы и текстуры", description: "Дерево, стекло, бетон и другие материалы для интерьера и экстерьера." },
      { number: "4", lessons: "Занятия 8–9", title: "Свет и окружение", description: "Естественное и искусственное освещение, атмосфера и работа с окружением." },
      { number: "5", lessons: "Занятия 10–12", title: "Финальная архитектурная сцена", description: "Сборка собственного проекта, настройка камеры, рендер и подготовка работы для портфолио." },
    ],
    format: "Онлайн-уроки, материалы, домашние задания и проверка работ. Гибкий темп — 1 или 2 занятия в неделю.",
    schedule: "1 или 2 раза в неделю",
  ...
  },
  {
    ...
    level: "Beginner",
    duration: "12 недель",
    summary: "Полный путь от знакомства с Blender до собственной 3D-работы с моделированием, материалами, светом, скульптингом и анимацией.",
    result: "Собственный законченный 3D-проект с моделированием, материалами, светом и анимацией, готовый для портфолио.",
    audience: "Новичкам, которые хотят освоить Blender системно и пройти путь от первых действий до самостоятельного проекта.",
    learn: ["уверенно работать с интерфейсом и навигацией Blender", "редактировать mesh и моделировать по референсам", "создавать материалы, свет и композицию кадра", "использовать скульптинг, модификаторы и базовую анимацию", "собирать и презентовать законченный проект для портфолио"],
    modules: [
      { number: "0", title: "Вводный модуль", description: "Практический модуль с изучением интерфейса, навигации и базовых действий в программе." },
      { number: "1", lessons: "Занятия 2–5", title: "Редактирование mesh и первый объект", description: "Режим редактирования, работа с вершинами, рёбрами и полигонами, экструдирование и создание первого объекта." },
      { number: "2", lessons: "Занятия 6–8", title: "Точное моделирование", description: "Работа с референсами, симметрией, пропорциями и новыми техниками построения формы." },
      { number: "3", lessons: "Занятия 9–12", title: "Материалы, свет и первый рендер", description: "Шейдинг, корректное освещение, работа с камерой и подготовка первого законченного рендера." },
      { number: "4", lessons: "Занятия 13–16", title: "Органичные формы и скульптинг", description: "Практика скульптинга, построение органичных форм и детализация модели." },
      { number: "5", lessons: "Занятия 17–20", title: "Основы анимации и модификаторы движения", description: "Анимация по ключевым кадрам и кривым, а также простые процедурные техники движения." },
      { number: "6", lessons: "Занятия 21–24", title: "Итоговый проект и полезные приёмы", description: "Моделирование собственного проекта, финальная доработка и подготовка работы для портфолио." },
    ],
    format: "Онлайн-уроки, материалы для изучения, домашние задания, проверка работ и наглядный прогресс. Занятия 2 раза в неделю.",
  ...
  },
  {
    ...
    level: "Intermediate",
    duration: "7 недель",
    summary: "Ключевые кадры, кривые движения, камера, процедурная анимация и собственный короткий 3D-ролик.",
    result: "Короткий анимационный ролик с продуманным движением, камерой и светом для портфолио.",
    audience: "Тем, кто уже знаком с основами Blender и хочет оживлять объекты и создавать выразительные короткие сцены.",
    learn: ["анимировать объекты по ключевым кадрам", "управлять скоростью и характером движения в Graph Editor", "настраивать движение камеры и свет", "использовать модификаторы, constraints и простую процедурную анимацию", "собирать и экспортировать короткий ролик"],
    modules: [
      { number: "0", title: "Принципы движения", description: "Таймлайн, ключевые кадры, темп, ритм и базовые принципы выразительной анимации." },
      { number: "1", lessons: "Занятия 2–3", title: "Ключи и Graph Editor", description: "Интерполяция, кривые, ускорение и замедление, работа с характером движения." },
      { number: "2", lessons: "Занятия 4–5", title: "Модификаторы и ограничения", description: "Constraints, циклы и модификаторы для управляемой и повторяющейся анимации." },
      { number: "3", lessons: "Занятия 6–8", title: "Камера и постановка сцены", description: "Движение камеры, композиция, фокус внимания и связь анимации со светом." },
      { number: "4", lessons: "Занятия 9–11", title: "Процедурное движение", description: "Drivers и простые процедурные приёмы для автоматизации движения объектов." },
      { number: "5", lessons: "Занятия 12–14", title: "Финальный motion-проект", description: "Сборка короткого ролика, финальный рендер и подготовка работы для портфолио." },
    ],
    format: "Онлайн-уроки, демонстрации, практические задания и разбор анимаций. Занятия 2 раза в неделю.",
    schedule: "2 раза в неделю",
    teacher: "Полина Крылова, 3D artist и motion designer",
  },
  {
    ...
    result: "Три законченные дизайн-работы и аккуратно оформленное мини-портфолио для публикации.",
    audience: "Новичкам в дизайне и тем, кто хочет быстро собрать первые разноплановые работы для портфолио.",
    learn: ["собирать выразительный макет лендинга", "проектировать понятный экран онбординга без перегруза", "создавать постер с сильной композицией и типографикой", "оформлять кейсы и публиковать работы на подходящих площадках"],
    modules: [
      { number: "1", lessons: "День 1", title: "Лендинг на выбранную тему", description: "Композиция, сетка, визуальная иерархия и основные правила оформления веб-макета." },
      { number: "2", lessons: "День 2", title: "Экран онбординга", description: "Структура первого пользовательского экрана, ясный текст и баланс информации без визуального перегруза." },
      { number: "3", lessons: "День 3", title: "Дизайн постера", description: "Работа с идеей, композицией, цветом и типографикой на свободную тему." },
      { number: "4", lessons: "Бонусный день", title: "Собираем портфолио", description: "Упаковка трёх работ, выбор площадок и публикация. В подарок — материалы для оформления: стикеры, текстуры и PDF с приёмами для Figma и AI-инструментами дизайнера." },
    ],
    format: "Четыре онлайн-занятия подряд: три практических дня с новой работой и бонусный день по сборке портфолио. Материалы и проверка работ включены.",
    schedule: "4 дня подряд",
    pricingText: "Стоимость интенсива уточняется",
    priceSummary: "уточняется",
    teacher: "Команда EduLearning",
  },
  {
    id: "python-zero",
    title: "Python с нуля",
...
function courseCard(course, options = {}) {
  ...
  return `
    <article class="card course-card-clickable" data-course-card="#/course/${course.id}" tabindex="0" role="link" aria-label="Открыть курс ${course.title}">
      ...
      ${course.pricingText ? `<p class="course-pricing-note">${course.pricingText}</p>` : coursePricing("course-pricing-compact")}
    ...
    <section class="split">
      <div class="grid">
        ...
        <article class="card">
          ...
          ${course.advantages
            ...
            : course.modules.map((item, index) => {
                const module = typeof item === "string"
                  ? { number: index + 1, title: item, description: "Практический модуль с уроками, материалами, заданием и контрольной точкой прогресса." }
                  : item;
                return `<div class="module">
                  <span class="module-index">${module.number ?? index + 1}</span>
                  <div>
                    <div class="module-heading"><h3>${module.title}</h3>${module.lessons ? `<span class="module-lessons">${module.lessons}</span>` : ""}</div>
        ...
        <article class="card">
          ...
          <p>${course.format || "Онлайн-уроки, видео, презентации, материалы, домашние задания, проверка работ и наглядный прогресс. Выберите комфортный темп: 2 или 3 занятия в неделю."}</p>
        </article>
        <article class="card">
          <h2>Стоимость</h2>
          ${course.pricingText ? `<p class="course-pricing-note course-pricing-note-large">${course.pricingText}</p>` : coursePricing("course-pricing-large")}
      ...
      <aside class="card">
        ...
        <ul class="meta-list">
          ...
          <li>${icon("credit-card")} Стоимость: ${course.priceSummary || coursePriceSummary}</li>
          <li>${icon("calendar-days")} Формат: ${course.schedule || courseScheduleSummary}</li>
